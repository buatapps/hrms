            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('guest'); ?>">Guest</a></li>
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate action="<?= base_url('guest/update/' . $list_data->id); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="col-xl-4 col-sm-12">
                            <input type="hidden" name="slug" value="<?= $list_data->slug; ?>">
                            <input type="hidden" name="oldLogo" value="<?= $list_data->logo; ?>">
                            <div class="mb-3">
