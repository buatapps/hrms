            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('product_synchronization'); ?>">Product Synchronization</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate action="<?= base_url('product_synchronization/update/' . $list_data->id); ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="col-4">
