        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate action="<?= base_url('attendance/save_absent_report'); ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <div class="col-xl-4 col-sm-12">
                                <input type="hidden" class="form-control" name="employee_id" value="<?= $employee->id; ?>" required>
                                <input type="hidden" class="form-control" name="employee_pin" value="<?= $employee->employee_pin; ?>" required>
                                <div class="mb-3">
