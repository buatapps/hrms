            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('employee_group'); ?>">Employee Group</a></li>
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate action="<?= base_url('employee_group/update/' . $list_data->id); ?>" method="post">
                        <?= csrf_field(); ?>
