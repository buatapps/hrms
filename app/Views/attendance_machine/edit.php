        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate action="<?= base_url('attendance_machine/update/' . $list_data->id); ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="col-xl-4 col-sm-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= (validation_show_error('ip')) ? 'is-invalid' : ''; ?>" id="ip" name="ip" value="<?= old('ip', $list_data->ip); ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="key" name="key" value="<?= old('key', $list_data->key); ?>" required>
                            </div>
