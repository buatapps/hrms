                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center mt-0 fw-bold"><?= lang('Auth.resetYourPassword') ?></h4>
                            </div>
                            ...
                            <form action="<?= url_to('reset-password') ?>" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control <?php if (session('errors.token')) : ?>is-invalid<?php endif ?>" type="text" id="username" name="token" placeholder="<?= lang('Auth.token') ?>" value="<?= old('token', $token ?? '') ?>" required>
