            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('inventory_out'); ?>">Inventory Transactions Out</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form class="needs-validation" novalidate action="<?= base_url('inventory_out/update'); ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="col-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type_id" class="form-control">
                                    <?php foreach ($types as $row): ?>
                                        <option value="<?= $row->id; ?>" <?= ($row->id == $list_data->type_id) ? 'selected' : '' ?>><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="mb-3">
