<!DOCTYPE html>
<html lang="en" data-layout-mode="fluid" data-topbar-color="light" data-menu-color="dark" data-sidenav-size="condensed">

<head>
    <meta charset="utf-8" />
    <title>HRMS | Error 404</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <a class="btn btn-info mt-3" href="javascript:history.back();"><i class="mdi mdi-reply"></i> Return Home</a>
                            </div>
                        </div> <!-- end card-body-->
                    </div>
                    <!-- end card -->
